...
//
    ...
    float _LightIntensity = lerp(0,(0.299*_MainLightColor.r + 0.587*_MainLightColor.g + 0.114*_MainLightColor.b)*attenuatedLightColor,_WorldSpaceLightPos0.w) ;
    //v.2.0.5: Filtering the high intensity zone of PointLights
    float3 Set_LightColor = lerp(lightColor,lerp(lightColor,min(lightColor,_MainLightColor.rgb*attenuatedLightColor*_1st_ShadeColor_Step),_WorldSpaceLightPos0.w),_Is_Filter_HiCutPointLightColor);
    //
